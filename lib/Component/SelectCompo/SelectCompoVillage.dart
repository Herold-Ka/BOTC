...
class SelectCompoVillage extends StatefulWidget {
  const SelectCompoVillage({Key? key}) : super(key: key);

  @override
  State<SelectCompoVillage> createState() => _SelectCompoVillage();
}

class _SelectCompoVillage extends State<SelectCompoVillage> {
  @override
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
          image: DecorationImage(
              image: AssetImage(
                'assets/image/background/Fond-bleu.png',
              ),
              fit: BoxFit.fitWidth)),
