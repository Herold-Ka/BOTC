...
class SelectCompoMalefique extends StatefulWidget {
  const SelectCompoMalefique({Key? key}) : super(key: key);

  @override
  State<SelectCompoMalefique> createState() => _SelectCompoMalefique();
}

class _SelectCompoMalefique extends State<SelectCompoMalefique> {
  @override
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
          image: DecorationImage(
              image: AssetImage(
                'assets/image/background/Fond-violet.png',
              ),
              fit: BoxFit.fitWidth)),
